...
<body>
    ...
    <div class="container">
        <div class="d-inline-block"><img class="float-left" src="assets/img/40.png" style="width: 120px;">
            <div class="d-inline-block float-left progress-report-text">
                <p class="text-left progress-report-student-name">Michelle Anatolia</p>
                <p class="text-left progress-report-program-name">SMARTIE</p>
            </div>
        </div>
        <div class="progress-report-list-button-group"><button class="btn btn-primary float-right progress-report-button bold" type="button" style="font-size: 13px;"><i class="fa fa-book"></i>&nbsp;Generate Report Book</button></div><button class="btn btn-primary float-left attendance-input-button"
            type="button" style="font-size: 13px;"><i class="fa fa-sort-up"></i>&nbsp;Sort by Newest</button>
